  ...
  return (
    <Container maxWidth="xl" className={classes.root}>
      ...
      <Typography variant="subtitle1" gutterBottom paragraph>
        この利用規約（以下，「本規約」といいます。）は，管理人がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
      </Typography>
      {simpleList("第1条（適用）", [
      ...
      {simpleList("第3条（ユーザーIDおよびパスワードの管理）", [
